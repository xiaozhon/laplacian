...
'''
import sys
inf_sensor = open("data_pkt_indriya_20161024_formatted.txt", "r")
inf_summary = open("summary_pkt_indriya_20161024_formatted.txt", "r")
 
inf_cs = open("cs_pkt_indriya_20161024_formatted.txt", "r")

outf = open("20161024-rctp_indriya_all_packets.txt", "w")
