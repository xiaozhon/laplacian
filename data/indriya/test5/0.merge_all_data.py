...
'''
import sys
inf_sensor = open("data_pkt_indriya_20161003_formatted.txt", "r")
inf_summary = open("summary_pkt_indriya_20161003_formatted.txt", "r")
#inf_routing = open("routing_pkt_20160818_formatted.txt", "r")	# DON'T add routing packets
 
inf_cs = open("cs_pkt_indriya_20161003_formatted.txt", "r")

outf = open("20161003-ctp_indriya_all_packets.txt", "w")
