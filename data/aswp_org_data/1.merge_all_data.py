...
'''
import sys
inf_sensor = open("data_pkt_20160624_20160918_formatted.txt", "r")
inf_summary = open("summary_pkt_20160624_20160918_formatted.txt", "r")
inf_routing = open("routing_pkt_20160624_20160918_formatted.txt", "r")	# DON'T add routing packets
inf_cs = open("cs_pkt_20160624_20160918_formatted.txt", "r")
#inf_cs = open("cs_pkt_20160818.txt", "r")

outf = open("20160624_20160918-rctp_all_packets.txt", "w")
...
for line in sensor_lines:
	...
	if line_count > 1 and len(s) > 0:
		...
		newline = s[0] + ' '  + s[1] + ' ' + s[2] + ' ' + s[4] + ' ' + s[5] + ' '
		newline = newline + s[9] + ' ' + s[10] + ' ' + s[11] + ' ' + s[15] + ' '
		newline = newline + s[14] + ' ' + s[13] + ' ' + s[12] + ' ' + s[16] + ' '
		newline = newline + s[21] + ' ' + s[22] + ' ' + s[23] + ' ' + s[24] + ' '
		newline = newline + s[17] + ' ' + s[18] + ' ' + s[19] + ' ' + s[20] + ' '
