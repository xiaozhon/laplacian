...
x_ticks = [i for i in range(0, len(total_trees)+5, 20)]
...
x_ticks = [i for i in range(0, len(dynamic_ratio)+5, 20)]
ax.set_xticks(x_ticks)
ax.set_xticklabels(x_ticks,size=8)
...
x_ticks = [i for i in range(0, len(inter_trees)+5, 20)]
ax.set_xticks(x_ticks)
ax.set_xticklabels(x_ticks,size=8)
...
x_ticks = [i for i in range(0, len(inter_ratio)+5, 20)]
ax.set_xticks(x_ticks)
ax.set_xticklabels(x_ticks,size=8)
