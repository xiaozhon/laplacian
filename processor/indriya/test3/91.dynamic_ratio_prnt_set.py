...
N = 98
TOTAL_CYCLES = 13
INTERVAL = 2	# two cycles

#inf = open("../../../data/indriya/test7_power_full/cs_pkt_indriya_20161015_formatted.txt", "r")
inf = open("../../../data/indriya/test3/20160929-rctp_indriya_all_packets.txt", "r")

inf_ids = open("../../../data/indriya/test3/nodeids.txt", "r")

inf_cycle_prr = open('../../../data/indriya/test3/node_prr_per_cycle.txt', 'r')
