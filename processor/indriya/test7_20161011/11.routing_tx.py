...
inf = open("../../../data/indriya/test7_20161011/summary_pkt_indriya_20161011_formatted.txt", "r")
...
inf_ids = open("../../../data/indriya/test7_20161011/nodeids.txt", "r")
...
#			print str(round_count) + ': ' + str(tmp)
	...
	if cur_reset[idx(s[SRC])] < pre_reset[idx(s[SRC])]:
		### We don't have reboot here in the Indriya network
		cur_reset[idx(s[SRC])] = pre_reset[idx(s[SRC])]
