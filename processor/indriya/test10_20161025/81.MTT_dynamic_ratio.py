...
CYCLES = 5 # divide data by the number of CYCLES

inf = open("../../../data/indriya/test10_20161025/cs_pkt_indriya_20161025_formatted.txt", "r")
...
inf_ids = open("../../../data/indriya/test10_20161025/nodeids.txt", "r")
...
yticks = [i for i in range(18, 35, 4)]
...
#print min(inter_trees)
#print max(inter_trees)
#yticks = [i for i in range(int(min(inter_trees)), int(max(inter_trees)), 2)]
#ax.set_yticks(yticks)
#ax.set_yticklabels(yticks,size=7)	# this to reduce y label font
...
#yticks = [1e-13*i for i in range(0, 30, 5)]
#ax.set_yticks(yticks)
#ax.set_yticklabels(yticks, size=7)	# this to reduce y label font
