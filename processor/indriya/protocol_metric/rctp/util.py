...
def blocks(inf):
	...
	count = 0
	DATA_LINE = 1
	COUNTER = 3		# round count in Sink
	COUNTER = 5		# sequence number
...
#			print line
			...
			if len(s) > 3 and s[DATA_LINE] == "Received:":
				### data line
...
#	yield block		## the last block is incomplete
...
#	testfile = open('../../../../data/indriya/protocol_metrics/rctp/20170209_indriya_rctp_lpl1024_sink31_30sec_test1.txt','r')
#	counter = 0
