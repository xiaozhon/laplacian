...
#	outf_all = open('prntSet_analysis_result_noise_add_more.txt', 'w')
...
#		infname = '../../../../data/indriya/protocol_metrics/rctp/20170212_indriya_rctp_lpl1024_sink31_30sec_cca1800_test1.txt'		
		...
		infname = '../../../../data/indriya/protocol_metrics/ctp/20170222_indriya_ctp_lpl1024_sink31_1min_caa1800_incycle_sink_alwaysON_test2.txt'
		
		
		outfname = 'prnt_set_analysis_result_1.txt'# + str(i) + '.txt'
		
		testname = 'Ctp-' + str(i)
		
		print testname + ': ' + infname + '\n\n'
		
		run_analyzer(testname, infname, outfname, outf_all, 3)
