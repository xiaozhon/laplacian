...
#inf = open("../../data/indriya/test4/cs_pkt_indriya_20160929_formatted.txt", "r")
...
inf_cycle_prr = open('../../../data/indriya/test5/node_prr_per_cycle.txt', 'r')
...
################### load cycle prr #######################
cycle_prr = []
cycle_prr_per_nodes = [[] for i in range(251)]
