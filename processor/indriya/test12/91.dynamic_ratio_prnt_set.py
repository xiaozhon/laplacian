...
inf = open("../../../data/indriya/test12/20161031-rctp_indriya_all_packets.txt", "r")

inf_ids = open("../../../data/indriya/test12/nodeids.txt", "r")

inf_cycle_prr = open('../../../data/indriya/test12/node_prr_per_cycle.txt', 'r')
