...
plt.savefig('figures/smallest_non-zero_eigen.png', dpi=300)
plt.clf()

fig_t = plt.plot(first_eig[0:76], 'ro')
plt.plot(first_eig[0:76], 'b')
#plt.axis([0, 100, 0, 2.0])

plt.savefig('figures/smallest_non-zero_eigen_76cycles.png', dpi=300)
plt.clf()
