...
#	hop_prnt = {}
	...
	cycle_count = 0
	for cycle in multi_blocks(inf, 3):	### merge 3 cycles to compute the parent set
		"""
		...
		cycle_count += 1
		if cycle_count < 2 or cycle_count > 5:	### Use two cycle data to verify the code
			continue
...
#	outf_all = open('analysis_result_entropy_all.txt', 'w')
