...
#		plt.savefig('figures_intersect_3/intersect_' + str(i+1) + '.png', dpi=300)
#		plt.clf()
		...
		plt.legend([extra_dr, extra_isolated, extra_conn], 
				...
				loc='best')
		plt.title('Intersect_' + str(i) + '_' + str(i+1) + '_' + str(i+2))
		plt.savefig('figures_intersect_3/intersect_' + str(i) + '_' + str(i+1) + '_' + str(i+2) + '.png', dpi=300)
		plt.clf()
		
		gmap.draw('figures_intersect_3/intersect_' + str(i) + '_' + str(i+1) + '_' + str(i+2) + '.html')
