...
#					plt.plot([node_locs[i][0], node_locs[j][0]], [node_locs[i][1], node_locs[j][1]], 'cyan')
					link = [(node_locs[i][0], node_locs[j][0]), (node_locs[i][1], node_locs[j][1]) ]
...
#		plt.clf()
		...
		gmap.draw('figures/A-tree_' + s[0] + '_' + s[1]+ '.html')
		########################################################################
