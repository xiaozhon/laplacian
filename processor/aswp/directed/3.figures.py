...
inf = open('Directed_Laplacian_eigenvalue.txt', 'r')
...
#			plt.axis([0, 100, 0, 2.0])
			...
			plt.savefig('figures_directed/am_' + times[idx-1] + '.png')
			plt.clf()
...
plt.savefig('figures_directed/am_smallest_non-zero_positive_eigen.png')
plt.clf()
