...
//    signal SensorReader.readingsDone(error, volt, hum, temp, adc0, adc1, adc2, adc3, adc6, adc7, 0, 0);
   signal SensorReader.readingsDone(SUCCESS, volt, hum, temp, 1000, 1500, 2000, 4095, 0, 0, 0, 0);
  ...
  task void dummyReadings(){
		...
		if (re_sampled < 1 && (adc0 < ADC0_MIN || adc0 > ADC0_MAX || adc1 < ADC1_MIN || adc1 > ADC1_MAX)) {
			...
			call Power.clr();
   			...
   			signal SensorReader.readingsDone(error, volt, hum, temp, adc0, adc1, adc2, adc3, adc6, adc7, 0, 0);
  //			signal SensorReader.readingsDone(SUCCESS, volt, hum, temp, adc0, adc1, adc2, re_sampled*10, total_sample_count*10, re_sample_count*10, 0, 0);
  			signal SensorReader.readingsDone(SUCCESS, volt, hum, temp, adc0, adc1, adc2, adc3, adc6, re_sample_count*10, 0, 0);
